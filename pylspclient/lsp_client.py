...
VersionedTextDocumentIdentifier= lsp_structs.VersionedTextDocumentIdentifier
...
class LspClient(object):
    ...
    async def initialize(self, processId, rootPath, rootUri, initializationOptions,
        ...
        return await (self.lsp_endpoint.call_method(
            "initialize",
            processId=processId,
            rootPath=rootPath,
            rootUri=rootUri,
    ...
    async def initialized(self):
        ...
        """
        return self.lsp_endpoint.send_notification("initialized")
    ...
    async def exit(self):
        ...
        for example to dynamically register capabilities. The initialized notification may only be sent once.
        """
        return await self.lsp_endpoint.send_notification("exit")

    async def didOpen(self, textDocument: VersionedTextDocumentIdentifier):
        """
        ...
        """
        return self.lsp_endpoint.send_notification("textDocument/didOpen",
                                                   textDocument=textDocument)

    async def didChange(self, textDocument: VersionedTextDocumentIdentifier, contentChanges):
        """
    ...
    async def documentSymbol(self, textDocument: VersionedTextDocumentIdentifier):
        """
    ...
    async def definition(self, textDocument: VersionedTextDocumentIdentifier, position):
        """
        ...
        """
        result_dict = await self.lsp_endpoint.call_method("textDocument/definition",
                                                    textDocument=textDocument,
                                                    position=position)
        return [lsp_structs.Location(**l) for l in result_dict]

    async def typeDefinition(self, textDocument: VersionedTextDocumentIdentifier, position):
        """
    ...
    async def signatureHelp(self, textDocument: VersionedTextDocumentIdentifier, position):
        """
            ...
            :param Position position: The position inside the text document.
            """
        result_dict = await self.lsp_endpoint.call_method(
            "textDocument/signatureHelp",
            textDocument=textDocument,
            position=position)
        return lsp_structs.SignatureHelp(**result_dict)

    async def completion(self, textDocument: VersionedTextDocumentIdentifier, position, context):
        """
        The signature help request is sent from the client to the server to request signature information at a given cursor position.            
        ...
        """
        return await self.lsp_endpoint.call_method("textDocument/completion",
                                                    textDocument=textDocument,
                                                    position=position,
                                                    context=context)
    ...
    async def declaration(self, textDocument: VersionedTextDocumentIdentifier, position):
        """
        ...
        result_dict = await self.lsp_endpoint.call_method("textDocument/declaration",
                                                    textDocument=textDocument,
                                                    position=position)
